...
INPUT_FILES += ["./IZZE_Brake_IR_4CE.dbc", "./IZZE_Brake_IR_4D3.dbc", "./IZZE_SG_4E2.dbc", "./IZZE_SG_4E4.dbc", "./IZZE_SG_4E5.dbc", "./IZZE_SG_4E6.dbc", "./IZZE_SG_4E7.dbc", "./IZZE_WL_SG_429.dbc", "./IZZE_WL_SG_42A.dbc", "./Kistler_S350.dbc"]
